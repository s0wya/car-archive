...
class TorqueValidatorTest {

    private final static TorqueValidator validator = new TorqueValidator();
    ...
    static class TestSet implements ArgumentsProvider {
        ...
        public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
            return Stream.of(
                    caseWith(0 , List.of(TORQUE_LESS_THAN_ZERO)),
                    caseWith(-1 , List.of(TORQUE_LESS_THAN_ZERO)),
                    caseWith(-1200 , List.of(TORQUE_LESS_THAN_ZERO)),
                    caseWith(1 , List.of()),
